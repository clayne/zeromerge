...
const unsigned char jc_build_api_versiontable[] = {
	0, //LIBJODYCODE_CACHEINFO_VER,
	0, //LIBJODYCODE_JODY_HASH_VER,
	LIBJODYCODE_OOM_VER,
	0, //LIBJODYCODE_PATHS_VER,
	LIBJODYCODE_SIZE_SUFFIX_VER,
	0, //LIBJODYCODE_SORT_VER,
	LIBJODYCODE_STRING_VER,
	0, //LIBJODYCODE_STRTOEPOCH_VER,
	0, //LIBJODYCODE_WIN_STAT_VER,
